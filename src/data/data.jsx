...
export const userBiodata = [
  {
    id: "001",
    data: [
      { nama: "Jeson Adhi Dharma", jabatan: "Chief Marketing Officer", angkatan: "B26" },
      { question: "Umur", answer: 19 },
      { question: "Tempat, tanggal lahir", answer: "Jakarta, 25 Desember 2004" },
      { question: "Jurusan", answer: "Computer Science and Statistics" },
      { question: "Hobi", answer: "Tidur (Rata - rata 6 jam 15 menit)" },
      { question: "Matkul Kesukaan", answer: "Theory of Statistics 1" },
      { question: "Kenapa Memilih Jurusan Ini", answer: "Aku tertarik dengan statistika sejak SMA dan melihat adanya prospek yang baik di bidang ini." },
      { question: "Tips Belajar", answer: "Fokus saat belajar dan mengulang materi setelah selesai kelas." },
      { question: "Bergabung dengan BNCC karena", answer: "Di SMA aku kurang memiliki pengalaman dalam mengelola tim dan berbicara di depan umum." },
      { question: "Nilai yang Didapat dari BNCC", answer: "Aku mendapat banyak connection dan juga mendapat beragai soft skill seperti time management dan kemampuan berbicara di depan orang banyak." },
      { question: "Event BNCC yang Paling Membekas", answer: "Product Development Conference di Mandiri Tower." },
      { question: "Pengalaman Sebagai Aslab / Anggota IT DIV", answer: "Aku tidak pernah mengikuti seleksi Aslab. Di IT DIV, aku mencoba ujian logika tetapi kelewatan jamnya." },
      { question: "Jika Bisa Kembali ke Masa Lalu, Saran Aku", answer: "Tidak menyia-nyiakan waktu." },
      { question: "Materi LnT", answer: "Mobile App Development." },
      { question: "Tugas Cavis", answer: "Membuat poster, mengembangkan backend, dan menulis artikel." }
    ],
  },
  {
    id: "002",
    data: [
      ...
      { question: "Hobi", answer: "Nonton video" },
      { question: "Video apa saja yang ditonton", answer: "Tidak terpaku pada satu hal saja." },
      { question: "Matkul Kesukaan", answer: "Object-Oriented Programming (OOP)" },
      { question: "Bergabung dengan BNCC karena", answer: "Aku ingin mengembangkan soft skills dan memperlancar transisi dari SMA ke perkuliahan." },
      { question: "Value dari BNCC", answer: "BNCC memberi banyak manfaat, hampir seluruh portofolio pengalaman organisasiku diisi oleh BNCC." },
      { question: "Bagaimana cara mengelola waktu", answer: "Prioritaskan yang paling penting dan jangan menunda pekerjaan." },
